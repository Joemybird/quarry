---------------------------------------
-- Quarry: system version 1.52
-- Creator: Joseph51
-- Description: A program that creates a square hole down to bedrock
-- using the given size, S, making sides of 2(s)+1
--
-- Updates: Created comment header and added turtle.attack() to resolve
-- issues with entities blocking the turtle path
---------------------------------------
...
bool = turtle.forward()
if bool==true then
if Direction=="+x" then -- Add to direction
x=x+1
move=move+1
elseif Direction=="-x" then
x=x-1
...
print("Error occured in Reocver Mode.")
IsOn=false
error()
end
end
